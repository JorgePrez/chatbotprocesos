...
prompt_template_procesos = create_prompt_template_procesos()
...
procesos_chain = (
    ...
    .assign(response = prompt_template_procesos | model | StrOutputParser())
    .pick(["response","context"])

)

def run_procesos_chain(question, history):
    inputs = {
        "question": question,
        "historial": history
    }
    return procesos_chain.stream(inputs)
