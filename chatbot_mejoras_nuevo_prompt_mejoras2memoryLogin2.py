...
def authenticator_login():
   ...
   ## st.set_page_config(page_title='Procesos UFM 🔗')
    ...
    if st.session_state["authentication_status"]:
        ...
        ##st.write(f'Welcome *{st.session_state["usernamename"]}*')
        ##st.write(f'Welcome *{st.session_state["name"]}*')
    ...
    st.divider()
        ...
        # Botón para mostrar el registro de usuarios

    if not st.session_state["authentication_status"]:

       # if st.button("Registrar nuevo usuario"):
            try:
                    email_of_registered_user, username_of_registered_user, name_of_registered_user = authenticator.register_user(merge_username_email=True, captcha =False, fields={ 'Form name':'Registrar nuevo usuario', 'Username':'Nombre de usuario','Form name':'Registrar usuario', 'First name': 'Nombre' , 'Last name': 'Apellido' , 'Email':'Email', 'Password':'Contraseña', 'Repeat password':'Repetir contraseña', 'Password hint':'Password hint ( Ingresa una pista o frase que te ayude a recordar tu contraseña.)', 'Register':'Registrar Usuario' })
